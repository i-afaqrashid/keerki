<template>
  <div class="w-90 pt-9">
    ...
    >
      ...
      <div class="w-100 admin-notification-unread border-bottom py-15 d-flex justify-content-center align-items-center">
          <div class="d-flex justify-content-between w-90 flex-column flex-sm-row align-items-center">
