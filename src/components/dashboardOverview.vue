<template>
  ...
  >
    <DashboardCard
      v-bind:title="'Orders History'"
      v-bind:footer="'Click here'"
    ...
    />
    <div
      class="d-none d-lg-flex align-items-center justify-content-end text-dark w-100 mt-xl-14"
    >
      <svg
        width="30"
        height="30"
