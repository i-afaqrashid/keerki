<template>
          <div v-if="alert == 1 || alert > 8 || isNaN(alert) ">
          ...
          >
            ...
            <div class="ml-4">
              ...
              <p class="font-weight-lighter mb-0">
                Contact Keerki if you need help
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div class="ml-4">
              <p class="mb-0">
                Your session expired due<br />to inactivity. Please log in
                again.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div class="ml-4">
              <p class="mb-0">
                Technical difficulty. Sorry for the<br />inconvenience; please
                try again.
              </p>
            </div>
          </div>
