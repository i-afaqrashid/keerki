    ...
    <div class="notifications">
      ...
      >
        <div class="text-center text-lg-left">
          <h1 class="font-24">{{$t('allMessages')}}</h1>
          <p class="fs-18 mb-0 font-weight-lighter">{{$t('newMessages')}}</p>
        </div>
        ...
        <div class="active-notification py-lg-4 py-2 w-100">
          ...
          >
            <div class="px-lg-5 text-center text-sm-left">
              <h1 class="fs-18 font-weight-light">{{$t('messageOrderShipped')}}</h1>
      ...
      <div class="border-bottom mb-5 mb-md-9 d-flex flex-column flex-lg-row">
        <div class="active-notification py-lg-4 py-2 w-100">
          ...
          >
            <div class="px-lg-5 text-center text-sm-left">
              <h1 class="fs-18 font-weight-light">{{$t('messageOrderDelivered')}}</h1>
              <div class="d-flex w-100 justify-content-between">
                <p class="mb-0 font-weight-lighter ml-2 ml-lg-0">
                  {{$t('message1Minute')}}
                </p>
