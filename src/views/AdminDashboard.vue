<template>
  <div
    class="w-100 d-flex justify-content-center bg-f7"
  >
    <div
      class="w-18 d-none d-lg-flex align-content-between flex-column text-white"
    >
      <div
      ...
      >
        ...
        <div class="w-100 pt-16">
          ...
          >
            ...
            <span class="fs-19 mb-0 text-muted w-50 text-left">Dashboard</span>
          </button>
        </div>
    ...
    <div class="w-82 px-lg-15 d-flex flex-column">
      <div class="d-flex flex-column pt-15 justify-content-center align-items-center">
        <div
          class="w-100 d-flex justify-content-around flex-column flex-lg-row align-items-center"
        >
          <div class="w-100 px-lg-5 order-1 order-lg-0">
            <svg
              width="34"
              height="34"
              viewBox="0 0 34 34"
          ...
          <div
            class="w-100 d-flex justify-content-between align-items-center order-1 order-lg-0 pt-4 pt-lg-0"
          >
